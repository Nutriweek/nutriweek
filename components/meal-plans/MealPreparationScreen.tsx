...
import { DEFAULT_FOOD_PREFERENCE, FOOD_PREFERENCES, FOOD_PREFERENCE_VALUES, type FoodPreference } from "@/lib/planning/food-preferences";
...
type MealPreparationScreenProps = {
  ...
  onGenerate: (preference: WeeklyPreference, foodPreference: FoodPreference, slots: MealSlotSelection[]) => void;
};
...
export default function MealPreparationScreen({ slots, initialSlots, categoryLabels, allowSlotSelection, initialPreference, isGenerating, message, onGenerate }: MealPreparationScreenProps) {
  ...
  const [foodPreference, setFoodPreference] = useState<FoodPreference>(DEFAULT_FOOD_PREFERENCE);
